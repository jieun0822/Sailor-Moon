...
public:
	...
	image* addImage(string strKey, const char* fileName, const int x, int y, const int const width, const int height, bool trans, COLORREF transColor);
	...
	void alphaRender(string strKey, HDC hdc, const int destX, const int destY, const int sourX, const int sourY, const int sourWidth, const int sourHeight, BYTE alpha);
